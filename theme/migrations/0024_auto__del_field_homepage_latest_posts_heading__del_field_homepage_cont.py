...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HomePage.testimonials_heading'
        db.add_column(u'theme_homepage', 'testimonials_heading',
                      self.gf('django.db.models.fields.CharField')(default='About us!', max_length=200),
                      keep_default=False)

        # Adding field 'HomePage.testimonials_subheading'
        db.add_column(u'theme_homepage', 'testimonials_subheading',
                      self.gf('django.db.models.fields.CharField')(default='What other people say about us...', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HomePage.testimonials_heading'
        db.delete_column(u'theme_homepage', 'testimonials_heading')

        # Deleting field 'HomePage.testimonials_subheading'
        db.delete_column(u'theme_homepage', 'testimonials_subheading')
