...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.features_heading'
        db.add_column(u'theme_homepage', 'features_heading',
                      self.gf('django.db.models.fields.CharField')(default='Features', max_length=200),
                      keep_default=False)

        # Adding field 'HomePage.features_text'
        db.add_column(u'theme_homepage', 'features_text',
                      self.gf('django.db.models.fields.CharField')(default='With Logicon you get a tonne of features out of the box', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.features_heading'
        db.delete_column(u'theme_homepage', 'features_heading')

        # Deleting field 'HomePage.features_text'
        db.delete_column(u'theme_homepage', 'features_text')
    ...
    models = {
        ...
        u'theme.homepage': {
            ...
            'features_text': ('django.db.models.fields.CharField', [], {'default': "'With Logicon you get a tonne of features out of the box'", 'max_length': '200'}),
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'parallax_heading': ('django.db.models.fields.CharField', [], {'default': "'Parallax scrolling atits finest.'", 'max_length': '200'}),
            'parallax_image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'parallax_subheading': ('django.db.models.fields.CharField', [], {'default': "'Display your photosin a new way.'", 'max_length': '200'}),
