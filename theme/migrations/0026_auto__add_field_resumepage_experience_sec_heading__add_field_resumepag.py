...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumePage.experience_sec_heading'
        db.add_column(u'theme_resumepage', 'experience_sec_heading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ResumePage.education_sec_heading'
        db.add_column(u'theme_resumepage', 'education_sec_heading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ResumePage.skills_sec_heading'
        db.add_column(u'theme_resumepage', 'skills_sec_heading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ResumePage.publications_sec_heading'
        db.add_column(u'theme_resumepage', 'publications_sec_heading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumePage.experience_sec_heading'
        db.delete_column(u'theme_resumepage', 'experience_sec_heading')

        # Deleting field 'ResumePage.education_sec_heading'
        db.delete_column(u'theme_resumepage', 'education_sec_heading')

        # Deleting field 'ResumePage.skills_sec_heading'
        db.delete_column(u'theme_resumepage', 'skills_sec_heading')

        # Deleting field 'ResumePage.publications_sec_heading'
        db.delete_column(u'theme_resumepage', 'publications_sec_heading')
    ...
    models = {
        ...
        u'theme.resumepage': {
            ...
            'education_sec_heading': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'experience_sec_heading': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'publications_sec_heading': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'resume_image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'skills_sec_heading': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
