...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomeFormPage'
        db.create_table(u'theme_homeformpage', (
            (u'form_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['forms.Form'], unique=True, primary_key=True)),
            ('fffheading', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'theme', ['HomeFormPage'])


    def backwards(self, orm):
        # Deleting model 'HomeFormPage'
        db.delete_table(u'theme_homeformpage')
    ...
    models = {
        ...
        u'theme.homeformpage': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'HomeFormPage', '_ormbases': [u'forms.Form']},
            'fffheading': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
