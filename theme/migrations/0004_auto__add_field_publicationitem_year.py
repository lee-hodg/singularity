...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicationItem.year'
        db.add_column(u'theme_publicationitem', 'year',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicationItem.year'
        db.delete_column(u'theme_publicationitem', 'year')
