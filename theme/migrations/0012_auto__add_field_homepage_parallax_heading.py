...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.parallax_heading'
        db.add_column(u'theme_homepage', 'parallax_heading',
                      self.gf('django.db.models.fields.CharField')(default='Parallax scrolling at its finest.', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.parallax_heading'
        db.delete_column(u'theme_homepage', 'parallax_heading')
    ...
    models = {
        ...
        u'theme.homepage': {
            ...
            'subheading': ('django.db.models.fields.CharField', [], {'default': "'Display your photos in a new way.'", 'max_length': '200'})
        },
        u'theme.iconblurb': {
