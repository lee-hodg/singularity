...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomePage.subheading'
        db.delete_column(u'theme_homepage', 'subheading')

        # Deleting field 'HomePage.heading'
        db.delete_column(u'theme_homepage', 'heading')


    def backwards(self, orm):
        # Adding field 'HomePage.subheading'
        db.add_column(u'theme_homepage', 'subheading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'HomePage.heading'
        db.add_column(u'theme_homepage', 'heading',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
