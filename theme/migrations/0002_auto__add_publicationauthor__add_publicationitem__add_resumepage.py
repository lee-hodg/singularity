...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'theme_publicationauthor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal(u'theme', ['PublicationAuthor'])
        ...
        db.create_table(u'theme_publicationitem', (
            ...
            ('arxivhref', self.gf('django.db.models.fields.CharField')(max_length=2000, blank=True)),
            ('primaryClass', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'theme', ['PublicationItem'])

        # Adding M2M table for field authors on 'PublicationItem'
        m2m_table_name = db.shorten_name(u'theme_publicationitem_authors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('publicationitem', models.ForeignKey(orm[u'theme.publicationitem'], null=False)),
            ('publicationauthor', models.ForeignKey(orm[u'theme.publicationauthor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['publicationitem_id', 'publicationauthor_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'theme_publicationauthor')

        # Deleting model 'PublicationItem'
        db.delete_table(u'theme_publicationitem')

        # Removing M2M table for field authors on 'PublicationItem'
        db.delete_table(db.shorten_name(u'theme_publicationitem_authors'))
    ...
    models = {
        ...
        u'theme.publicationauthor': {
            'Meta': {'ordering': "('title',)", 'object_name': 'PublicationAuthor'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        ...
        u'theme.publicationitem': {
            ...
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'arxivhref': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'}),
            'arxivident': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'publicationauthors'", 'blank': 'True', 'to': u"orm['theme.PublicationAuthor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
