...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExperienceItem.short_url'
        db.delete_column(u'theme_experienceitem', 'short_url')

        # Deleting field 'ExperienceItem.site'
        db.delete_column(u'theme_experienceitem', 'site_id')

        # Deleting field 'ExperienceItem.keywords_string'
        db.delete_column(u'theme_experienceitem', u'keywords_string')

        # Deleting field 'ExperienceItem.in_sitemap'
        db.delete_column(u'theme_experienceitem', 'in_sitemap')

        # Deleting field 'ExperienceItem.title'
        db.delete_column(u'theme_experienceitem', 'title')

        # Deleting field 'ExperienceItem.status'
        db.delete_column(u'theme_experienceitem', 'status')

        # Deleting field 'ExperienceItem.updated'
        db.delete_column(u'theme_experienceitem', 'updated')

        # Deleting field 'ExperienceItem.description'
        db.delete_column(u'theme_experienceitem', 'description')

        # Deleting field 'ExperienceItem.expiry_date'
        db.delete_column(u'theme_experienceitem', 'expiry_date')

        # Deleting field 'ExperienceItem.slug'
        db.delete_column(u'theme_experienceitem', 'slug')

        # Deleting field 'ExperienceItem.gen_description'
        db.delete_column(u'theme_experienceitem', 'gen_description')

        # Deleting field 'ExperienceItem.created'
        db.delete_column(u'theme_experienceitem', 'created')

        # Deleting field 'ExperienceItem._meta_title'
        db.delete_column(u'theme_experienceitem', '_meta_title')

        # Deleting field 'ExperienceItem.publish_date'
        db.delete_column(u'theme_experienceitem', 'publish_date')

        # Adding field 'ExperienceItem._order'
        db.add_column(u'theme_experienceitem', '_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExperienceItem.short_url'
        db.add_column(u'theme_experienceitem', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.site'
        db.add_column(u'theme_experienceitem', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'ExperienceItem.keywords_string'
        db.add_column(u'theme_experienceitem', u'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.in_sitemap'
        db.add_column(u'theme_experienceitem', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.title'
        db.add_column(u'theme_experienceitem', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'ExperienceItem.status'
        db.add_column(u'theme_experienceitem', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'ExperienceItem.updated'
        db.add_column(u'theme_experienceitem', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.description'
        db.add_column(u'theme_experienceitem', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.expiry_date'
        db.add_column(u'theme_experienceitem', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.slug'
        db.add_column(u'theme_experienceitem', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.gen_description'
        db.add_column(u'theme_experienceitem', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.created'
        db.add_column(u'theme_experienceitem', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ExperienceItem._meta_title'
        db.add_column(u'theme_experienceitem', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperienceItem.publish_date'
        db.add_column(u'theme_experienceitem', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ExperienceItem._order'
        db.delete_column(u'theme_experienceitem', '_order')
