...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AboutPage.history'
        db.add_column(u'theme_aboutpage', 'history',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'AboutPage.values'
        db.add_column(u'theme_aboutpage', 'values',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AboutPage.history'
        db.delete_column(u'theme_aboutpage', 'history')

        # Deleting field 'AboutPage.values'
        db.delete_column(u'theme_aboutpage', 'values')
