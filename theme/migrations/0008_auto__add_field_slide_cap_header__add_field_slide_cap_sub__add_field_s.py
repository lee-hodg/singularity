...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.cap_header'
        db.add_column(u'theme_slide', 'cap_header',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Slide.cap_sub'
        db.add_column(u'theme_slide', 'cap_sub',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Slide.cap_image1'
        db.add_column(u'theme_slide', 'cap_image1',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Slide.cap_image2'
        db.add_column(u'theme_slide', 'cap_image2',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.cap_header'
        db.delete_column(u'theme_slide', 'cap_header')

        # Deleting field 'Slide.cap_sub'
        db.delete_column(u'theme_slide', 'cap_sub')

        # Deleting field 'Slide.cap_image1'
        db.delete_column(u'theme_slide', 'cap_image1')

        # Deleting field 'Slide.cap_image2'
        db.delete_column(u'theme_slide', 'cap_image2')
