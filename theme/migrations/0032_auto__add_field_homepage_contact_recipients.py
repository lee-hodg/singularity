...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.contact_recipients'
        db.add_column(u'theme_homepage', 'contact_recipients',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.contact_recipients'
        db.delete_column(u'theme_homepage', 'contact_recipients')
