...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumePage.publications_subsec_heading'
        db.add_column(u'theme_resumepage', 'publications_subsec_heading',
                      self.gf('django.db.models.fields.CharField')(default='My work', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumePage.publications_subsec_heading'
        db.delete_column(u'theme_resumepage', 'publications_subsec_heading')
