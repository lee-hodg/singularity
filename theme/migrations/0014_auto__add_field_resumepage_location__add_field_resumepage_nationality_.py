...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumePage.location'
        db.add_column(u'theme_resumepage', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ResumePage.nationality'
        db.add_column(u'theme_resumepage', 'nationality',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ResumePage.dob'
        db.add_column(u'theme_resumepage', 'dob',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ResumePage.statement'
        db.add_column(u'theme_resumepage', 'statement',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumePage.location'
        db.delete_column(u'theme_resumepage', 'location')

        # Deleting field 'ResumePage.nationality'
        db.delete_column(u'theme_resumepage', 'nationality')

        # Deleting field 'ResumePage.dob'
        db.delete_column(u'theme_resumepage', 'dob')

        # Deleting field 'ResumePage.statement'
        db.delete_column(u'theme_resumepage', 'statement')
