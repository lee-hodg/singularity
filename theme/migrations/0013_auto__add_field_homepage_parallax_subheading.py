...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.parallax_subheading'
        db.add_column(u'theme_homepage', 'parallax_subheading',
                      self.gf('django.db.models.fields.CharField')(default='Display your photos in a new way.', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.parallax_subheading'
        db.delete_column(u'theme_homepage', 'parallax_subheading')
