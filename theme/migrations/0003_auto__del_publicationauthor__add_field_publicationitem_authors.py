...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicationItem.authors'
        db.add_column(u'theme_publicationitem', 'authors',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PublicationItem.authors'
        db.delete_column(u'theme_publicationitem', 'authors')
