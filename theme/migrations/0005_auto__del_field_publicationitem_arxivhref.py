...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PublicationItem.arxivhref'
        db.delete_column(u'theme_publicationitem', 'arxivhref')


    def backwards(self, orm):
        # Adding field 'PublicationItem.arxivhref'
        db.add_column(u'theme_publicationitem', 'arxivhref',
