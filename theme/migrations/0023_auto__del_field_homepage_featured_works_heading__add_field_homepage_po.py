...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HomePage.portfolio_sec_heading'
        db.add_column(u'theme_homepage', 'portfolio_sec_heading',
                      self.gf('django.db.models.fields.CharField')(default='Portfolio', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HomePage.portfolio_sec_heading'
        db.delete_column(u'theme_homepage', 'portfolio_sec_heading')
