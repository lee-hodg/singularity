...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomePage.features_text'
        db.alter_column(u'theme_homepage', 'features_text', self.gf('mezzanine.core.fields.RichTextField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'HomePage.features_text'
        db.alter_column(u'theme_homepage', 'features_text', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'theme.homepage': {
            ...
            'features_text': ('mezzanine.core.fields.RichTextField', [], {'default': "'With Logicon you get a tonne of features out of the box'", 'max_length': '200'}),
