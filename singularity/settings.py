...
PAGE_MENU_TEMPLATES = ((1, "Index top nav bar", "pages/menus/dropdown.html"),
...
DATABASES = {
    "default": {
        ...
        "NAME": os.path.join('/srv/databases', 'db.singularity.sqlite3'),
    }
}
...
STATIC_ROOT = '/srv/www/singularity/static/'
...
MEDIA_ROOT = '/srv/www/singularity/media/'
